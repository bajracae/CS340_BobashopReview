...
<body>
	...
	if (mysqli_num_rows($result) > 0) {
		echo "<h1 class='table'>" . $row['Name'] . "</h1>";
	...
	echo "<div style=\"text-align:center;\">";
		echo "<input id=\"addButton\" type=\"Button\" value=\"Back to List of Customers\" style=\"width:300px;height:50px;font-size:20px;margin:10px;\" onclick=\"window.location='listCustomers?user=" . $user . "'\">";
	echo"</div>";
	?>
